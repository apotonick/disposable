...
class HashWithExternalClassTest < MiniTest::Spec
  Model = Struct.new(:id, :content)

  class SongContent < Disposable::Twin
    property :title
    property :band do
      property :name
  ...
  class Song < Disposable::Twin
    ...
    property :id
    property :content, field: :hash, twin: SongContent
  end
  ...
  describe "coercion" do
    ...
    class CoercingSongContent < Disposable::Twin
      feature Coercion
    ...
    class Coercing < Disposable::Twin
      ...
      property :content, field: :hash, twin: CoercingSongContent
    end
  ...
  describe "::unnest" do
    class Unnesting < Disposable::Twin
      ...
      property :id
      content=property :content, field: :hash, twin: SongContent
